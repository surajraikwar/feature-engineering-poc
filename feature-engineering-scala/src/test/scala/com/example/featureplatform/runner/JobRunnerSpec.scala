...
import com.example.featureplatform.config.{JobConfig, JobConfigLoader, SourceDefinition, SourceRegistry}
import com.example.featureplatform.utils.SparkSessionTestWrapper
import org.apache.spark.sql.{DataFrame, Row, SparkSession} // Added SparkSession import
